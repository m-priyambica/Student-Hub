...
const VerifyEmail = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setToast({ type: "success", message: "Email verified successfully. Redirecting to login..." });
  ...
  const handleResend = async () => {
    if (!email) {
      setToast({ type: "info", message: "Email not found. Please register again." });
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        setToast({ type: "success", message: "New code sent to your email." });
      } else {
