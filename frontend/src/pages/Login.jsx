...
import { User, Lock, ArrowRight, Loader2, AlertCircle } from "lucide-react"; // Added AlertCircle for errors
...
const Login = () => {
  ...
  useEffect(() => {
    ...
    }, 100); // Slowed down slightly for smoother effect
    ...
    <div className="min-h-screen w-full flex items-center justify-center relative bg-white font-sans text-slate-900">
      ...
      <div className="relative z-10 w-full max-w-xs sm:max-w-sm px-4 flex flex-col items-center">
        ...
        <form onSubmit={handleLogin} className="w-full space-y-4">
            ...
            <div className="relative group">
                ...
                <input 
                    ...
                    className="w-full bg-gray-50 border border-slate-200 rounded-xl py-4 pl-12 pr-4 text-slate-900 placeholder-slate-400 font-medium outline-none transition-all duration-300
                                focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 hover:border-orange-300"
                />
            </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
            <Link to = "/reset-password-start" className="text-slate-500 hover:text-orange-600 text-sm font-medium transition-colors">
                Forgot password?
            </Link>
